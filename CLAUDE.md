...
Current version: see `.qfdm.version` set at the bottom of `core/init.q` (today: 0.62).

Test status: `q tests/run_all_tests.q` → **372 passed / 0 failed**.
