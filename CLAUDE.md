...
Current version: see `.qfdm.version` set at the bottom of `core/init.q` (today: 0.65).

Test status: `q tests/run_all_tests.q` → **378 passed / 0 failed**.
