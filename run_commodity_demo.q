...
/ Kirk spread option
kirkCall:.commodity.spread.kirkPrice[`call;75f;70f;3f;0.25;0.30;0.25;0.8;0.05];
...
ss:.commodity.electricity.sparkSpread[45f;3.5;7f];
-1 "  power=$45  gas=$3.5  HR=7  spark=$",string ss;
-1 "";
