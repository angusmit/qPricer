...
trade:`tradeId`productType`basketSymbols`basketWeights`optionType`exerciseStyle`strike`expiry`notional!(
    1;`basketOption;`AAPL`MSFT`NVDA;0.4 0.3 0.3;`put;`european;400f;1f;100000f);
...
.testutil.assertTrue[priceResult[`unitPrice]>0f;"basket put price positive"];
.testutil.assertTrue[priceResult[`standardError]>0f;"SE positive"];

-1 "PASS test_basket_option_put: price=",string[priceResult`unitPrice],", SE=",string priceResult`standardError;
