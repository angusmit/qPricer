...
if[priceDiff>tolerance; '"FAIL test_local_vol_flat_equivalence_call: diff=",string priceDiff];
if[not localVolUnitPrice>0f; '"FAIL: local vol call price not positive"];

-1 "PASS test_local_vol_flat_equivalence_call: flat=",string[flatUnitPrice],", localVol=",string[localVolUnitPrice],", diff=",string priceDiff;
