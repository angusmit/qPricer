/ test_greeks_call.q — validate FDM Greeks for European call
\l core/init.q
...
bsG:.validation.blackScholesGreeks[`call;100f;100f;1f;0.05;0f;0.2];
...
if[not allPass; '"FAIL test_greeks_call: d=",string[dErr]," g=",string[gErr]," t=",string[tErr]," v=",string[vErr]," r=",string rErr];
-1 "PASS test_greeks_call: delta=",string[first fdmG`delta],", gamma=",string[first fdmG`gamma],", theta=",string[first fdmG`theta],", vega=",string[first fdmG`vega],", rho=",string first fdmG`rho;
